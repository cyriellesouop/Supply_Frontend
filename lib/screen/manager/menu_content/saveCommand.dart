...
class SaveCommand extends StatefulWidget {
  ...
  SaveCommand({required this.currentManagerID, Key? key}) : super(key: key);

  @override
  _SaveCommandState createState() => _SaveCommandState();/*  */
}

class _SaveCommandState extends State<SaveCommand> {
